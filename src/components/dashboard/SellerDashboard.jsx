...
import { getSellerStats } from "@/app/dashboard/actions";
...
export default async function SellerDashboard({ userId, userName }) {
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body2" sx={{ color: "#6b7280", mt: 0.5 }}>
          Here&apos;s an overview of your listings performance.
        </Typography>
      </Box>
